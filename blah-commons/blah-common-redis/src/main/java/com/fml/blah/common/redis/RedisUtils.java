...
public class RedisUtils {
   ...
   * @param key 1
   * @param value 2
   * @param score 3 @Description:zset,创建key及初试分数
   */
  ...
  /**
   * @Description: zset 给定key，增加score @Date:2020-04-06
   *
   * @param key 1
   * @param val 2
   * @param score 3
  ...
  public Set<ZSetOperations.TypedTuple<Object>> zRankByRange(
      String key, Integer start, Integer end) {
    try {
  ...
  /**
   * @Author Lee @Description: 删除给定key的给定范围内的值，如果begin,end传null则删除当前key @Date:2020-04-06
   *
   * @param key 1
   * @param begin 2
   * @param end 3
  ...
  /**
   * @Author Lee @Description: 将前两个key下的值合并到第三个curKey中 @Date:2020-04-06
   *
   * @param curKey 1
   * @param yesterKey 2
   * @param beforeKey 3 @Return: void
   */
